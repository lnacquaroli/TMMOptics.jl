...
# Materials profile for each different layer: the nprofile keeps all the information about how this materials will be placed in the structure. Here there incident material is air, then number 2 in nprofile is the looyenga with 0.86 porosity, the number 3 in nprofile is silicon substrate. The number of elements inside this variable must match the maximum value of nprofile
