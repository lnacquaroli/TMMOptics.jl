...
function pbgplot(λ::AbstractArray{T,M}, θ::AbstractArray{U,N}, d::AbstractArray{W,P}, Rp::AbstractArray{X,Q}, Rs::AbstractArray{X,Q}, R::AbstractArray{X,Q}, kblochp::AbstractArray{A1,B1}, kblochs::AbstractArray{A1,B1}, kbloch::AbstractArray{A1,B1}) where {T<:Number, M, U<:Number, N, W<:Number, P, X<:Number, Q, A1<:ComplexF64, B1}
